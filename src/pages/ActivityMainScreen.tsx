...
export function ActivityMainScreen({
  ...
  const validatedCount = activities.filter(
    (a) => a.status?.toLowerCase() === "validated"
  ).length;
  ...
  return (
    <div className="h-full bg-white">
      {/* Fixed header – same style as other screens */}
      <div
      ...
      {/* Spacer so content doesn't hide behind header (match ~72px header) */}
      <div className="h-[110px]" />

      {/* Scrollable content, same padding pattern as other pages */}
      <div
      ...
      >
        ...
        <div className="space-y-4">
          {loading && (
            <p className="text-center text-[#888] py-6">Loading...</p>
          )}
