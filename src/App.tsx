...
export default function App() {
  ...
  const isActivityDetailRoute = location.pathname.match(/^\/activity\/[^/]+$/);
  ...
  const activeTab = useMemo(() => {
    ...
    if (p.startsWith("/my-bookings") || p.startsWith("/upcoming"))
      return "upcoming";
  ...
  return (
    <div className="h-full w-full overflow-hidden">
      ...
      {authed && isUpcomingRoute && <MyBookingsScreenHeader />}
