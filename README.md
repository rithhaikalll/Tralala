...
| 3 | Activity Reminder Module | Pages <br> <ul><li>[Actvity Event Screen](src/pages/Activity%20Tracking/ActivityEventScreen.tsx)</li> <li>[Create Event Screen](src/pages/Activity%20Tracking/CreateEventScreen.tsx)</li> <li>[Event Detail Screen](src/pages/Activity%20Tracking/EventDetailScreen.tsx)</li></ul> | Supabase Connection <br> [Supabase Client](src/lib/supabaseClient.ts) |
