...
| 2 | Dashboard Personalizzation Module |Pages <br> <ul><li> Update All Pages to Apply Dark Mode and Language</li></ul> <li> [Interface Setting Screen](src/pages/InterfaceSettingsScreen.tsx)</li> <li> [Navbar Setting Screen](src/pages/NavbarSettingsScreen.tsx)</li>| Translation Library <br> <ul><li> [translation.ts](src/lib/translation.ts)</li></ul> Preference Context <br> <ul> <li>  [UserPreferencesContext.tsx](src/lib/UserPreferencesContext.tsx)</li></ul> |
